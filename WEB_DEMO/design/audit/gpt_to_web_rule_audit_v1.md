...
| 工人被抓 | lost，释放任务锁和矿山占用 | 必须继承 | v0.5 部分实现 | 已实现 lost 与普通任务释放；矿山占用释放留到矿山版本 |
...
| 黑影目标优先级 | 辉石 > 围墙 > 工人 > 弓箭手 > 返程流民 > 玩家 | 必须继承 | v0.5 部分实现 | 已实现辉石 > 工人 > 玩家 > 家园推进；围墙、弓箭手、返程流民留到对应版本 |
...
| HUD | 显示天数、阶段、辉石、人口、单位、夜晚黑影计数 | 必须继承信息价值 | v0.5 部分实现 | 已显示当前版本所需的天数、阶段、辉石、工人、撤退、失踪和黑影信息 |
